...
- [功率调平与能力协商](hsp-g9804/power-leveling.md) — Power Levelling、Registration 能力字段、25GS-PON 广播 ID

### EPON / 10G-EPON (IEEE 802.3ah / 802.3av)

- [概览（对照）](epon-10gepon/overview.md) — MPCP / GATE / REPORT / LLID / OMCI over EPON
- [EPON OAM 与 OMCI over EPON](epon-10gepon/oam-omci.md) — 扩展 OAM 帧、LLID、与 802.3 clause 57 OAM 映射
...
- [GPON vs XGS-PON：参数与时序数值对照](gpon-vs-xgspon.md) — 线速率/帧长/FEC/封装头/授权粒度并排

### 物理层与编码

- [前向纠错（FEC）原理与各代对照](fec-principles.md) — RS / BCH(HEC) / LDPC、码字布局、净编码增益
- [光功率预算与光链路（ODN class）](optical-power-budget.md) — OPL 等级 B+/C+/N1/N2/E1/E2、衰减范围、差分/距离/波长
